  ...
  <div class="modal" v-show="show">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-body">
          <form>
            <label for="selection-name">Название</label>
            <input type="text" id="selection-name" name="selectionName" placeholder="" v-model="newSelection.selectionName">

            <label for="description">Описание</label>
            <input type="text" id="description" name="description" placeholder="" v-model="newSelection.description">
  ...
  methods: {
    createResource(event) {
      ...
      if (this.errors.length === 0) {
        this.newSelection.resources = this.selectedResources;
        this.$emit('createSelection', this.newSelection);
        this.newSelection.selectionName = '';
        this.newSelection.description = '';
    ...
    validateForm() {
      ...
      if (!this.newSelection.selectionName) {
        this.errors.push('Необходимо указать название подборки.');
      }

      if (this.selectedResources.length === 0) {
        this.errors.push('Необходимо указать ресурсы.');
      }
    },
  },
  created() {
    this.selectedResources = ['Learning C# for beginners', 'Vue.js + C# Как начать?', 'Vue.js + Asp.Net Core MVC', 'Node.js приложение с нуля', 'Высоконагруженные приложения'];
  }
}
</script>
